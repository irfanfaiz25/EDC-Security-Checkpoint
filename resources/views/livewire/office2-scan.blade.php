    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div wire:submit.prevent='scanCheckpoint' class="card-body">
                    <form action="">
                        ...
                        <input wire:model='scanOffice2' type="password" class="form-control form-control-sm"
        ...
        <div class="col-md-8">
            <div class="image-container">
                <img src="{{ asset('img/checkpoint/officel2.png') }}" alt="Image" class="image-checkpoint">
