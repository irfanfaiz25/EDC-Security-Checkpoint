                ...
                <tbody>
                    ...
                    @foreach ($checkpoints as $checkpoint)
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                @php
                                    $resultEndInt = $this->calculateCountdown();
                                    $endInt = $resultEndInt['endInt'];
                                @endphp
                                @if (!empty($checkpoint->status) && $endInt >= 0)
                                    <span class="text-success fw-medium">
                                        @php
                                            $resultEndTime = $this->calculateCountdown();
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div wire:submit.prevent='scanCheckpoint' class="card-body">
                    <form action="">
                        ...
                        <input wire:model='scanDmc2' type="password" class="form-control form-control-sm"
        ...
        <div class="col-md-8">
            <div class="image-container">
                <img src="{{ asset('img/checkpoint/dmcl2.png') }}" alt="Image" class="image-checkpoint image-rotate">
